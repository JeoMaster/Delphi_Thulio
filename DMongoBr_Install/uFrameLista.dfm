object framePacotes: TframePacotes
  ...
  object MongoCore_dpk: TCheckBox
    Left = 46
    Top = 3
    Width = 163
    Height = 17
  ...
  object MongoVCLAnniversary_dpk: TCheckBox
    Tag = 3
    Left = 62
    Top = 73
    Width = 163
    ...
    Margins.Right = 0
    Margins.Bottom = 0
    Caption = 'MongoVCLAnniversary.dpk'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
