...
type
  ...
  TframePacotes = class(TFrame)
    Label1: TLabel;
    MongoCore_dpk: TCheckBox;
    MongoFMX_dpk: TCheckBox;
    MongoVCLAnniversary_dpk: TCheckBox;
    MongoVCL_dpk: TCheckBox;
...
begin
  ...
  // instalação mínima do DmongoBr
  MongoCore_dpk.Checked := True;
